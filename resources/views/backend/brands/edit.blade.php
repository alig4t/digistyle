                  ...
                  <form role="form" method="POST" action="{{route('brands.update',$brand->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{$brand->name}}" placeholder="وارد کردن نام ...">
                      </div>
  
                      <div class="form-group">
                        <label>نام لاتین برند</label>
                        <input type="text" name="slug" class="form-control" value="{{$brand->slug}}" placeholder="وارد کردن نام لاتین ...">
                      </div>

                      <div class="form-group d-block">
                        <label class="d-block" for="exampleFormControlFile1">لوگو برند</label>
                        @if($brand->logo)
                        <img src="{{$brand->logo['images'][120]}}">
                        @endif
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="editor1" type="text" name="desc" class="form-control" placeholder="در مورد برند بنویسید ...">{{$brand->description}}</textarea>
                      </div>
