        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">تعریف رنگ جدید</li>
                  ...
                  <form role="form" method="POST" action="{{route('colors.store')}}">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <label class="d-block">مثال : زرشکی</label>

                        <input type="text" name="color" class="form-control" value="{{old('color')}}" placeholder="وارد کردن عنوان رنگ ...">
                      </div>
  
                      <div class="form-group">
                        <label>کد رنگ</label>
                        {{-- <input type="text" class="form-control my-colorpicker1 colorpicker-element"> --}}
                        <input type="text" name="hex" class="form-control my-colorpicker1 colorpicker-element">
                      </div>
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary">ایجاد رنگ</button>
                    </div>
