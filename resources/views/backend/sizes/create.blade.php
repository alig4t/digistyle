                  ...
                  <form role="form" method="POST" action="{{route('sizes.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="size" class="form-control" value="{{old('size')}}" placeholder="وارد کردن اندازه ...">
                      </div>
  
                      <div class="form-group">
                        <label>توضیح کوتاه سایز (اختیاری)</label>
                        <input type="text" name="description" class="form-control" value="{{old('description')}}" placeholder="وارد کردن توضیح (اختیاری)  ...">
                      </div>
