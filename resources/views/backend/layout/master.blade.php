  ...
  <nav class="main-header navbar navbar-expand navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('dashboard.index')}}" class="nav-link">خانه</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
علی قاسمی
      ...
      <li>
        <form action="{{route('logout')}}" method="post">
          @csrf
          <button type="submit" class="btn btn-info" >خروج از پنل کاربری</button>
        </form>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a class="brand-link">
      <span class="brand-text">پنل مدیریت فروشگاه</span>
    </a>
